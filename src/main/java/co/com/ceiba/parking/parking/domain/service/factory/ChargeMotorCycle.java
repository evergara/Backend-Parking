...
public class ChargeMotorCycle implements IChargeParking {
    ...
    private static final int VALUE_ADDICTIONAL = 2000;
    ...
    public void setCharge(Registry registry) {
        ...
        long totalHour = (long) Math.ceil(hour);
        long totalMinute = (long) Math.ceil(minute);
        ...
        if(Integer.valueOf(registry.getDisplacement()) > DISPLACEMENT_MAXIMUM ){
            value = value + VALUE_ADDICTIONAL;
        }
